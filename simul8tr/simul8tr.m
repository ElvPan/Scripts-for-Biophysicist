function [postConv,preConv] = simul8tr(sizeXdesired,sizeYdesired,sizeT,density,bleachType,bleachDecay,qYield,pixelsize,timesize,PSFType,PSFSize,PSFZ,noBits,diffCoeff,flowX,flowY,flowZ,countingNoise,backgroundNoise);
...
for i = 1:sizeT;
    ...
    elseif strcmp(PSFType,'asymg')
        postConv(:,:,i) = convolveAsymGaussian(sum(preConv,3),filtersize,PSFSize/pixelsize); 
...
postConv = formatSeriesLike
if backgroundNoise > 0Microscope(postConv, noBits);
% Adds counting noise
if countingNoise > 0
