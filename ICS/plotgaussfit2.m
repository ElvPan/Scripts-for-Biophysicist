function [fig] = plotgaussfit2(a, corrFun, pixelsize, whitenoise);
...
Xprim=X.*cos(a(1,7))-Y.*sin(a(1,7));
Yprim=X.*sin(a(1,7))+Y.*cos(a(1,7));


F = (a(1,1)*exp(    -((Xprim-a(1,5)).^2/(a(1,2)^2)+(Yprim-a(1,6)).^2/(a(1,3)^2))   ) + a(1,4));
